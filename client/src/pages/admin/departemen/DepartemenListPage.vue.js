...
function openEditModal(departemen) {
...
async function confirmDelete(departemen) {
...
const __VLS_0 = __VLS_asFunctionalComponent(AppDataTable, new AppDataTable({
    ...
    searchPlaceholder: "Cari departemen atau kode...",
    emptyText: "Belum ada data departemen",
}));
...
{
    const { 'cell-namaDepartemen': __VLS_thisSlot } = __VLS_2.slots;
...
{
    const { 'cell-kodeDepartemen': __VLS_thisSlot } = __VLS_2.slots;
    const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
        ...{ class: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-accent-50 text-accent-700 dark:bg-accent-500/10 dark:text-accent-400 font-mono" },
    });
    (row.kodeDepartemen);
}
{
    const { 'cell-kepala': __VLS_thisSlot } = __VLS_2.slots;
    const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
    if (row.kepala) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "w-8 h-8 rounded-full bg-primary-100 dark:bg-primary-500/10 flex items-center justify-center text-xs font-medium text-primary-600 dark:text-primary-400" },
        });
        (__VLS_ctx.getInitials(row.kepala.nama));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
...
const __VLS_8 = __VLS_asFunctionalComponent(AppModal, new AppModal({
    ...
    title: (__VLS_ctx.isEditing ? 'Edit Departemen' : 'Tambah Departemen'),
    size: "lg",
}));
...
/** @type {[typeof DepartemenForm, ]} */ ;
// @ts-ignore
const __VLS_15 = __VLS_asFunctionalComponent(DepartemenForm, new DepartemenForm({
    ...{ 'onSubmit': {} },
    ...{ 'onCancel': {} },
...
/** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
/** @type {__VLS_StyleScopedClasses['bg-accent-50']} */ ;
/** @type {__VLS_StyleScopedClasses['text-accent-700']} */ ;
/** @type {__VLS_StyleScopedClasses['dark:bg-accent-500/10']} */ ;
...
//# sourceMappingURL=DepartemenListPage.vue.js.map